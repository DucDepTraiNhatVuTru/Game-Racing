...
public class DoPostUser extends AsyncTask<String, Integer, String> {

    private Activity context;
    private ProgressDialog progressDialog;

    public DoPostUser(Activity context, ProgressDialog progressDialog){
    ...
    protected void onProgressUpdate(Integer... values) {
        if(values[0]==200||values[0]==201){
            ...
            txtvCanhBao.setText("Đăng ký thành công!");
        }
        else {
            progressDialog.cancel();
            TextView txtvCanhBao = context.findViewById(R.id.txtvCanhBao);
